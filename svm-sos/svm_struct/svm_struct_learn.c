                      ...
                      STRUCTMODEL *sm, int alg_type)
{
  ...
  } while(finalize_iteration(ceps,0,sample,sm,cset,alpha,sparm)
                            ...
                            STRUCTMODEL *sm, int alg_type)
{
  ...
  */
  ...
  } while(finalize_iteration(ceps,cached_constraint,sample,sm,cset,alpha,sparm) ||
          cached_constraint || (ceps > sparm->epsilon)           
         );
