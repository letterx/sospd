...
#data_files="$data_dir/108082.h5 $data_dir/109053.h5"
timestamp=$(date +%y-%m-%d-%H-%M-%S)
output_dir="/Users/afix/Work/Vision/CVPR15-results/all-results/$application/$timestamp"
output_link="/Users/afix/Work/Vision/CVPR15-results/$application-fusion-results"
...
methods="\
         sos_pair_fusion_grad \
         sos_cvpr_fusion_grad \
         sos_cardinality_fusion_grad"
